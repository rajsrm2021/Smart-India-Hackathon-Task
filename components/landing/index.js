      ...
      <div className="bg-[#fffcf8] overflow-hidden w-[1440px] h-[2400px] relative">
        <div className="absolute w-[1407px]  left-[6px]">
          ...
          <div className="relative w-[1407px] h-[2255px] top-1 left-0">
            <div className="absolute w-[1400px] h-[392px] top-[167px] left-[10px] bg-[#eefbf8] rounded-[58px] border-4 border-solid border-black">
              ...
              <Image
                className="absolute w-[300px] h-[300px] top-16 right-5 object-cover"
                src={logo9}
                height={300}
                width={300}
              />
